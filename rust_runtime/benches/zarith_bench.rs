...
fn rug_bench(c: &mut Criterion) {
    ...
    c.bench_function("nat_rug_to", |b| b.iter(|| black_box(n.to_bytes())));
    c.bench_function("nat_rug_from", |b| b.iter(|| black_box(N::from_bytes(n_bytes))));
    c.bench_function("int_rug_to", |b| b.iter(|| black_box(z.to_bytes())));
    c.bench_function("int_rug_from", |b| b.iter(|| black_box(Z::from_bytes(z_bytes))));
}
...
fn big_bench(c: &mut Criterion) {
    ...
    c.bench_function("nat_big_to", |b| b.iter(|| black_box(n.to_bytes())));
    c.bench_function("nat_big_from", |b| b.iter(|| black_box(N::from_bytes(n_bytes))));
    c.bench_function("int_big_to", |b| b.iter(|| black_box(z.to_bytes())));
    c.bench_function("int_big_from", |b| b.iter(|| black_box(Z::from_bytes(z_bytes))));
}
